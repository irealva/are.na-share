// Adapted from: https://unpkg.com/are.na@0.1.1/index.js
...
class ArenaAPI {
  ...
  _req(method, url, ...data) {
    let stringify = Qs.stringify(Object.assign({}, ...data), {indices:false});
    url = url + '?' + stringify;

    let result = this.requestHandler(method.toLowerCase(), url, stringify);
